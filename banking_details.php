      ...
      <div class="main">
       ...
       <div class="banking_box wrapper">
          <div class="f_left al_left bankdetails_box">
            ...
            <span class="d_block">В назначении платежа обязательно указать договор пожертвования № 2 от 01.02.2014 </span>
            <a href="#javascript:;" class="details d_in-block">Печать</a>
          </div>
         <img src="images/banking_details1.png" class="f_right banking_img" alt="picture">
       </div>
