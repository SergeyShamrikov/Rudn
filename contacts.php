...
<!--==============================content================================-->
  <div id="content">
      <div class="main">
        ...
        <div class="contact_top wrapper">
          <div class="contact_left f_left">
            <h2 class="contact_title title2 museo_font900">Контакты</h2>
            <ul class="contact_list">
              <li class="contact_list_item">
                Почтовый адрес (для официальных писем и корреспонденции):
              </li>
              <li class="contact_list_item">
              ...
              <li class="contact_list_item">
                <p>Телефоны: <br>
                Тел: +7 (495) 434-43-12,<br>
                Моб: +7 (916) 550-36-36 <br> 
                Факс: +7 (495) 433-15-11 <br>
                </p>
              </li>
              <li class="contact_list_item">
              ...
              <li class="contact_list_item">
                <p>Не нашли ответа на вопрос? Пишите: alumni@rudn.ru <br>
                Skype: Alumnirudn
                </p> 
              </li>
            </ul>
          </div>
          <div class="contact_right f_left">
            <p class="contact_title2">Как нас найти:</p>
            ...
            <div class="contact_text_right">
              <p class="contact_right_text2">Горячая линия для жертвователей<br><span>8 800 2000 600</span></p>
            </div>
          </div>
        </div>
        <div class="contact_bottom wrapper">
          ...
          <div class="contact_bottom_right f_left">
            ...
            Мобильный телефон +7 (916) 550-36-36</p>
          </div>
        </div>
      </div>
  </div>
